...
Living snapshot: [`CurrentState.md`](CurrentState.md).  
...
| [`TrainingRunbook.md`](TrainingRunbook.md) | Historical Create ML procedure (YOLO is `scripts/`) |
| [`OCRFusionPolicy.md`](OCRFusionPolicy.md) | Phase 7 text association rules (shipped) |
| [`CoordinateSpike.md`](CoordinateSpike.md) | Generator coordinate rules |
