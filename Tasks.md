...
| F1 | OS-FOCUS-04 | FOCUS-DET-05 | native incremental slice review (NUIAK architect); mixed-source scope open | [Handoff](reports/work/OS-FOCUS-03/handoff.md): protocol v2 integrates40 train/9 validation pairs; separate6-pair challenge has no pixel/lineage overlap. FDR-007 completes8 epochs,18/18 validation and12/12 challenge at0.85, matching FDR-006; no measured incremental gain. Next: runtime parity and new focus appearances, not more same-style epochs. General native/Fixture contract and scale gates remain open. |
| F1 | FOCUS-EXPORT-01 | FOCUS-DET-05 | software review / runtime blocked (NUIAK architect) | [Handoff](reports/work/FOCUS-EXPORT-01/handoff.md): export safety/identity and frozen challenge parity entrypoint verified; actual export stopped after612s in imports, import-only probe timed out60s in coremltools→sklearn→SciPy. No exported artifact or measured parity/size/latency. Resume after bounded local export-runtime readiness; no TTR dependency, training or promotion. |
...
| F1 | TVGEN-02 | FOCUS-DET-05 | review software / blocked live (NUIAK architect) | Admission review fixes omitted targets, initial/runtime binding, sweep taxonomy and visual-review hashes;44 Python and92 Swift tests pass. Source plan expects246 pairs/288 frames for42 recipes; no new capture. Native non_view binding still blocks live acceptance. [Review](reports/work/TVGEN-REVIEW/handoff.md); [prior live evidence](reports/work/TVGEN/handoff.md). |
...
| F1 | SIM-DATA-01 | TASK-SIM-DATA-01 | infrastructure ready / Fixture capture blocked (NUIAK architect) | [16:29Z follow-up](reports/work/TTR-CHECK-20260922-1622/fixture-followup.md): updated TTR readiness passes, ownership clear; Fixture HTTP restored, bytes unchanged, fresh current media_shelf telemetry still unresolved native focus. Historical job5063F0AF two-element smoke not repeated. No fresh screenshot failure, completed bundle or native remote qualification. |
