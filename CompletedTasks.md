...
Snapshot and maps:
- [`Research/CurrentState.md`](Research/CurrentState.md)
- [`Research/PhaseMap.md`](Research/PhaseMap.md)
- [`Research/FixtureBatchIngest.md`](Research/FixtureBatchIngest.md)
...
*Complete. Shipped detector is YOLO11n `nativeui-ios-v2.0` (mAP@0.5 = 0.935 CoreML). Create ML Runs 001–005 are historical.*
...
#### TASK-6-2: Train 5-class Create ML model ✅ — superseded 2026-08-23 by YOLO11n `nativeui-ios-v2.0`
...
#### TASK-6-5: Evaluation run ✅ — 5-class gates met via YOLO11n (mAP@0.5 = 0.935; generalization holdout 0.934)
...
#### TASK-6-6: Physical device benchmark ✅ — closed with 2.0.0 (~7.5 ms/image, well under 200 ms)
...
## Phase 6 Gate: Foundation Models Baseline Evaluation ✅ skipped
...
*In progress. Finished 6a-1 through 6a-9 are below. Remaining 6a-10/11/12: [`Tasks.md`](Tasks.md). Do not ship 41-class weights (Run 009 holdout mAP@0.5 = 0.586).*
...
#### TASK-6a-7: Full evaluation and real-world validation ✅ — Run 007 holdout mAP@0.5 = 0.358 (DS-G8 fail). Continued as 6a-8/9/10.
...
<!-- TASK-6a-10 / 6a-11 / 6a-12 remaining work moved to Tasks.md. Ingest notes: Research/FixtureBatchIngest.md -->

## Phase 6b: tvOS Model & OS UI Detection ✅ v3.0

*Shipped `nativeui-tvos-v3.0` (mAP@0.5 = 0.9822). Remaining scale-out / unify / FocusRing v1.0: [`Tasks.md`](Tasks.md).*
...
*R-2 / R-3 complete. Remaining R-1 scale (≥500 frames): [`Tasks.md`](Tasks.md).*
...
<!-- TASK-6b-R-1 remaining scale-out is in Tasks.md. R-2/R-3 below are complete. -->
...
<!-- Phase 6b-U and Phase 6c remaining — see Tasks.md -->

## Phase 7: OCR Fusion & Audit Rules ✅

*Complete. Visible text in `NativeUIElementObservation`, and 4 audit issue rules active.*
...
*TASK-9-1 (`NativeUIRecognizing`) complete. Remaining 9-2 / 9-3 live in ScreenAuditKit: [`Tasks.md`](Tasks.md).*
...
<!-- TASK-9-2 / 9-3 remaining — see Tasks.md -->
...
<!-- Track 3 remaining (history rewrite, next tag) — see Tasks.md -->
...
## Phase 6b-FD: FocusRingDetector — Stage 2 tvOS Focus Classifier ✅ v0.1

*v0.1 bundled 2026-09-18. Remaining v1.0 data (FOCUS-DET-05): [`Tasks.md`](Tasks.md). Spec: [`Research/FocusRingDetectorSpec.md`](Research/FocusRingDetectorSpec.md).*
